...
import {
  ...
  deleteItem,
  uploadPhotoName,
  getGananciasTotalesSNS,
  filterTagsByRegex,
  getItem,
  changeFileStatus,
  optenerGastosGananciasTotales,
  addCaracteristica,
  getItemsLowStock,
  getItemsNoStock,
  getAllItemsSubTipoName,
  optenerVentasPotenciales,
  getItemsMasVendido,
  reOrderItems,
  getGICofItem,
  ventasDeItemPorMesGrafico,
  addMarca,
  deleteMarcas,
  getMarcas,
  subCantidadUpdate,
...
import {
  ...
  getSubTipos,
  uploadPhotoNameCat,
  uploadPhotoNameSubCat,
  cambiarItemCarpeta,
  getSiteMapLinks,
  reOrderTipo,
  reOrderSubTipo,
  deleteSubTipoTransac,
  updateSubTipoTransac,
  updateTipoTransac,
  deleteTipoTransac,
...
routes.delete(
  "/deleteSupTipo/:codigo/:subTipoName",
  adminLoginRequired,
  deleteSubTipoTransac
);

routes.delete(
  "/marcas/delete/:deleteString",
  transaccionalLoginRequired,
  deleteMarcas
);
...
routes.get(
  "/getItemVentasPorMes/:codigoItem",
  normalLoginRequired,
  ventasDeItemPorMesGrafico
);
...
routes.post(
  "/uploads/imageSubCat/:codigo/:subCat",
  transaccionalLoginRequired,
  uploadImage.single("img"),
  imageUpload,
  deleteImage,
